...
HRESULT Filter::GetClassID(CLSID* p)
{
    ...
    *p = WebmTypes::CLSID_WebmColorConversion;
    return S_OK;
}
...
#ifdef _DEBUG
    odbgstream os;
    os << "webmcc::Filter::Stop(begin)" << endl;
#endif
...
#ifdef _DEBUG
    os << "webmcc::Filter::Stop(end)" << endl;
#endif
