...
#ifdef _DEBUG
        os << "vp9decoder::inpin::EOS: called pin->EOS; hr=0x"
           << hex << hr << dec
           << endl;
#endif
...
#ifdef _DEBUG
    wodbgstream os;
    os << "vp9dec::inpin::NotifyAllocator: props.cBuffers="
       << props.cBuffers
       << " cbBuffer="
       << props.cbBuffer
       << " cbAlign="
...
HRESULT Inpin::Start()
{
    ...
    const int flags = 0; //VPX_CODEC_USE_POSTPROC;
...
#if 0  // TODO: does VP9 suppor this?
