...
static CFactory s_factory(&s_cLock, &WebmOggSource::CreateInstance);
...
STDAPI DllGetClassObject(
    ...
    void** ppv)
{
    if (clsid == WebmTypes::CLSID_WebmOggSource)
...
STDAPI DllUnregisterServer()
{
    ...
    hr = ComReg::UnRegisterCoclass(WebmTypes::CLSID_WebmOggSource);
...
#if _DEBUG
    const wchar_t friendlyname[] = L"WebM Ogg Source Filter (Debug)";
#else
    const wchar_t friendlyname[] = L"WebM Ogg Source Filter";
#endif
